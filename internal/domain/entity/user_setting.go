...
type UserSetting struct {
	...
	ExcludedDependabotRepositories  []string
	...
	NotificationDependabotChannelID string // /dependabot コマンド用通知チャンネル
	UpdatedAt                       time.Time
}
...
func (u *UserSetting) NotificationChannelForDependabot() string {
	if u == nil {
		return ""
	}
	if u.NotificationDependabotChannelID != "" {
		return u.NotificationDependabotChannelID
	}
	return u.NotificationChannelID
}
